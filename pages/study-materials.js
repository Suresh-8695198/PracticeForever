...
import { BookOpen, ArrowLeft, Send, Sparkles } from 'lucide-react';
import { useTheme } from '@/context/ThemeContext';

export default function StudyMaterialsPlaceholder() {
  ...
  return (
    <div className={`min-h-screen pt-28 pb-20 flex flex-col items-center justify-center ${bg}`} style={{ fontFamily: 'Outfit, sans-serif' }}>
      <Head>
        <title>Syllabus & Study Materials | Practice Forever</title>
        <meta name="description" content="Download syllabus guides, placement materials, aptitude preparation cheat sheets, and coding notes. Coming soon." />
      ...
      <div className="max-w-xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className={`text-sm md:text-base leading-relaxed ${textMuted}`}>
            We are indexing standard syllabus configurations, notes, and downloadable preparation documents. Acquire formula cheat sheets for aptitude and programming reference charts.
          </p>
        </div>

        {/* Interactive Newsletter Box */}
        <div className={`border rounded-2xl p-6 ${cardBg}`}>
          <h3 className="text-xs font-black uppercase tracking-wider mb-2 text-amber-500">Join Material Waitlist</h3>
          <p className={`text-xs ${textMuted} mb-4`}>
            Enter your email to get free access to our primary Aptitude PDF bundle when it launches.
          </p>
