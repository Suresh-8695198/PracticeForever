...
<div class="news-feed-content">
    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">1. Resolution for Removal of Lok Sabha Speaker</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>Opposition members in the Lok Sabha have moved a resolution for the removal of Speaker Om Birla, citing partisan behaviour during parliamentary proceedings.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Union Minister Kiren Rijiju criticized the move as an "attack on democracy."</li>
                <li>The Speaker can only be removed by a resolution passed by a majority of the House members.</li>
                <li>The move highlights the intense friction between the government and the opposition.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Constitutional Insight</strong>
                <p>According to Article 94 of the Indian Constitution, the Speaker or Deputy Speaker may be removed by a resolution of the House of the People passed by a majority of all the then members of the House.</p>
            </div>
            <div class="editorial-box rose">
                <strong>Why It Matters</strong>
                <p>The neutrality of the Speaker is fundamental to parliamentary neutrality and the smooth democratic functioning of the legislative process.</p>
            </div>
        </div>
        <img src="/images/parliament.png" alt="Lok Sabha Speaker Debate" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">2. Natural Gas Shortage Impacts LPG Production</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>India is facing a temporary natural gas shortage, causing concern over the domestic supply of LPG and other energy products.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Norway and the United States remain key suppliers, but global demand is peaking.</li>
                <li>Domestic LPG production increased by 10% last year, but imports are still crucial.</li>
                <li>Supply chain delays are currently being addressed by the Ministry of Petroleum.</li>
            </ul>
            <div class="editorial-box amber">
                <strong>Primary Factors</strong>
                <p>The shortage is attributed to global supply chain disruptions and a sudden surge in household energy consumption compared to previous estimates.</p>
            </div>
            <div class="editorial-box rose">
                <strong>National Significance</strong>
                <p>Energy security is vital for maintaining economic stability and ensuring uninterrupted fuel supply to millions of Indian households.</p>
            </div>
        </div>
        <img src="/images/energy.png" alt="Energy Security Crisis" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">3. Assam Transfers ₹3,600cr to 40 Lakh Women</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Assam government has transferred ₹3,600 crore to approximately 40 lakh women as part of the Orunodoi welfare scheme.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>The scheme provides monthly financial assistance to Below Poverty Line (BPL) families.</li>
                <li>Recipients also received a ₹4,000 Bihu bonus for the upcoming festivities.</li>
                <li>Over ₹17,000 crore has been distributed since the scheme was launched in 2020.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Scheme Details</strong>
                <p>Orunodoi is the largest welfare scheme in Assam, aimed at ensuring financial dignity and social security for women in the state.</p>
            </div>
            <div class="editorial-box emerald">
                <strong>Key Objective</strong>
                <p>The primary goal is to empower women and provide immediate relief to economically vulnerable households across the state.</p>
            </div>
        </div>
        <img src="/images/welfare.png" alt="Orunodoi Welfare Scheme" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">4. UPSC Releases Civil Services Exam Marks</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Union Public Service Commission (UPSC) has officially released the marks and rank lists for the Civil Services Examination 2025.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Anuj Agnihotri topped the exam with 1071 marks (52.88%).</li>
                <li>A total of 958 candidates were recommended for various services.</li>
                <li>The marks for both the Mains (1750) and Interview (275) were uploaded online.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Exam Structure</strong>
                <p>The UPSC Civil Services Examination consists of three stages: Prelims, Mains, and the Personality Test (Interview), testing 2025 total marks.</p>
            </div>
            <div class="editorial-box rose">
                <strong>Quick Statistics</strong>
                <p>Successful candidates represent a diverse range of educational backgrounds, highlighting the inclusive nature of the selection process.</p>
            </div>
        </div>
        <img src="/images/upsc.png" alt="UPSC Results 2025" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">5. Rajasthan Removes Two-Child Norm</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Rajasthan Assembly has passed a bill to remove the "Two-child norm" for contesting Urban Local Body elections.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>The norm previously disqualified individuals with more than two children from contesting.</li>
                <li>The amendment was made to Section 24 of the Rajasthan Municipalities Act, 2009.</li>
            </ul>
            <div class="editorial-box emerald">
                <strong>Democratic Impact</strong>
                <p>Removing this restriction opens up leadership opportunities for a wider section of society in urban local governance across Rajasthan.</p>
            </div>
        </div>
        <img src="/images/governance.png" alt="Rajasthan Municipality Reform" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">6. Chandigarh Achieves 99.93% Literacy Rate</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>Chandigarh has recorded a historic 99.93% literacy rate under the New India Literacy Programme (ULLAS).</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>The achievement is aligned with the goals of the National Education Policy (NEP) 2020.</li>
                <li>Focused interventions helped surpass the previous 95% literacy benchmark.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Contributing Factors</strong>
                <p>The integration of the ULLAS programme and effective government monitoring were instrumental in achieving near-universal literacy in Chandigarh.</p>
            </div>
        </div>
        <img src="/images/literacy.png" alt="Chandigarh Education Success" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8">
        <div class="space-y-6">
            <strong class="section-title">7. Delhi Plans Green Budget 2026–27</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Delhi government has announced plans to introduce a comprehensive "Green Budget" for the financial year 2026–27.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>The budget will focus on environmental sustainability and pollution control.</li>
                <li>Allocations will target clean energy, waste management, and green jobs.</li>
            </ul>
            <div class="editorial-box emerald">
                <strong>Sustainability Goal</strong>
                <p>The Green Budget aims to institutionalize environmental accountability across pollution control, clean energy, and waste management.</p>
            </div>
        </div>
        <img src="/images/greenbudget.png" alt="Delhi Green Budget" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <h4>Quick Revision Points</h4>
    <ul>
        <li>Lok Sabha debates resolution on Speaker Om Birla's removal.</li>
        <li>India addresses temporary natural gas shortage with priority LPG supply.</li>
        <li>Assam distributes ₹3,600 crore to 40 lakh women under Orunodoi 2.0.</li>
        <li>UPSC releases marks for Civil Services Examination 2025 toppers.</li>
        <li>Rajasthan removes two-child norm for municipal election eligibility.</li>
        <li>Chandigarh hits near-universal literacy under ULLAS programme.</li>
        <li>Delhi announces plans for a dedicated sustainable 'Green Budget'.</li>
    </ul>

    <h4>Frequently Asked Questions</h4>
    <h4>1. Who topped the UPSC Civil Services Examination 2026?</h4>
    <p>Anuj Agnihotri secured Rank 1 with 1071 marks.</p>

    <h4>2. What is the Orunodoi scheme?</h4>
    <p>The Orunodoi scheme is a financial assistance programme launched by the Assam government to support women from economically weaker families.</p>

    <h4>3. What is a Green Budget?</h4>
    <p>A Green Budget focuses government spending on environmentally sustainable sectors such as clean energy, pollution control, and conservation.</p>

    <h4>4. Why is the natural gas shortage occurring in India?</h4>
    <p>The shortage is due to high demand and delays in imports, though supply from new sources may improve the situation.</p>
</div>
`
};

export const MARCH_12_ARTICLE = {
    id: 1,
    title: "Daily Current Affairs – 12 March 2026",
...
<div class="news-feed-content">
    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">1. Lok Sabha Rejects Motion to Remove Speaker Om Birla</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Lok Sabha rejected a resolution moved by opposition members seeking the removal of Speaker Om Birla after a heated debate in Parliament.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>The motion was defeated by a voice vote in the Lok Sabha.</li>
                <li>Opposition MPs protested remarks made by Union Home Minister Amit Shah.</li>
                <li>BJP MP Jagdambika Pal presided over the proceedings during the debate.</li>
                <li>The House rejected the motion as the Opposition continued slogan shouting.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Constitutional Insight</strong>
                <p>According to Article 94 of the Indian Constitution, the Lok Sabha Speaker can be removed through a resolution passed by a majority of the members of the House.</p>
            </div>
            <div class="editorial-box rose">
                <strong>Why It Matters</strong>
                <p>The event highlights parliamentary procedures, Speaker neutrality, and essential checks within the democratic system.</p>
            </div>
        </div>
        <img src="/images/parliament_debate_speaker_mar12.png" alt="Lok Sabha Speaker Debate" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">2. Iran Attacks Commercial Ships; Global Energy Concerns</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>Iran launched attacks on commercial ships in the Persian Gulf region, increasing global tensions and energy security concerns.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>An India-bound Thai cargo ship (Mayuree Naree) was hit near the Strait of Hormuz.</li>
                <li>Three crew members were reported missing; 20 rescued by the Omani Navy.</li>
                <li>Iranian drones also struck near Dubai International Airport.</li>
                <li>Oil prices rose sharply amid the conflict; IEA release 400M barrels.</li>
            </ul>
            <div class="editorial-box amber">
                <strong>Global Energy Impact</strong>
                <p>Oil prices rose sharply amid the conflict. The IEA announced the release of 400 million barrels of oil reserves to stabilise markets.</p>
            </div>
            <div class="editorial-box rose">
                <strong>Why It Matters</strong>
                <p>The Strait of Hormuz is one of the world's most important oil transit routes, handling nearly 20% of global petroleum supply.</p>
            </div>
        </div>
        <img src="/images/strait_of_hormuz_mar12.png" alt="Strait of Hormuz Conflict" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">3. Supreme Court Upholds ‘Right to Die with Dignity’</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>The Supreme Court allowed withdrawal of life-support treatment for a patient in a persistent vegetative state for 13 years.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Judgment concerned Harish Rana, who suffered severe injuries in 2013.</li>
                <li>Court permitted withdrawal of clinically assisted nutrition and hydration (CANH).</li>
                <li>Ruling follows the passive euthanasia guidelines established in 2018.</li>
            </ul>
            <div class="editorial-box emerald">
                <strong>Important Concept</strong>
                <p>The judgment emphasised "right to die with dignity" under Article 21 (Right to Life) of the Constitution.</p>
            </div>
            <div class="editorial-box blue">
                <strong>Why It Matters</strong>
                <p>The decision clarifies the legal framework for end-of-life medical care and patient dignity in India.</p>
            </div>
        </div>
        <img src="/images/supreme_court_mar12.png" alt="Supreme Court Euthanasia Ruling" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8 border-b border-dashed border-zinc-200 dark:border-zinc-800 pb-12 mb-12">
        <div class="space-y-6">
            <strong class="section-title">4. Taranjit Singh Sandhu Sworn in as Delhi Lieutenant-Governor</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>Former Indian diplomat Taranjit Singh Sandhu was sworn in as the 23rd Lieutenant Governor of Delhi.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Oath administered by Delhi HC Chief Justice Devendra Kumar Upadhyaya.</li>
                <li>Sandhu emphasised transforming Delhi into a "global capital."</li>
                <li>LG plays a crucial role in the NCT governing structure.</li>
            </ul>
            <div class="editorial-box blue">
                <strong>Why It Matters</strong>
                <p>The Lieutenant Governor is the administrative head of Delhi, balancing local governance with central administration.</p>
            </div>
        </div>
        <img src="/images/delhi_lg_mar12.png" alt="Delhi LG Swearing-In" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8">
        <div class="space-y-6">
            <strong class="section-title">5. Vijayanagara-Era Gold Treasure Discovered in Karnataka</strong>
            <strong class="sub-title">Why in News?</strong>
            <p>Archaeologists discovered gold ornaments in Lakkundi village estimated to be over 500–600 years old.</p>
            <strong class="sub-title">Key Points</strong>
            <ul>
                <li>Around 466 grams of gold ornaments discovered during house construction.</li>
                <li>Artifacts include pearls, emeralds, and blue sapphire from the Vijayanagara period.</li>
                <li>Estimated monetary value: ₹80 lakh; historical value is immeasurable.</li>
            </ul>
            <div class="editorial-box amber">
                <strong>History Highlight</strong>
                <p>The discovery provides deep insights into medieval South Indian culture and the prosperity of the Vijayanagara period.</p>
            </div>
        </div>
        <img src="/images/vijayanagara_gold_mar12.png" alt="Vijayanagara Gold Treasure" class="w-full h-48 md:h-44 object-cover rounded-xl shadow-md border border-zinc-200/50" />
    </div>

    <h4>Quick Revision Points</h4>
    <ul>
        <li>Lok Sabha rejected a resolution to remove Speaker Om Birla via voice vote.</li>
        <li>Iran launched drone and missile attacks on ships in the Persian Gulf.</li>
        <li>Supreme Court upheld "Right to Die with Dignity" for vegetative patients.</li>
        <li>Taranjit Singh Sandhu became the 23rd Lieutenant Governor of Delhi.</li>
        <li>Geopolitical tensions in West Asia sparked LPG shortage rumours in India.</li>
        <li>Meghalaya postponed GHADC elections due to unrest in West Garo Hills.</li>
        <li>500-year-old Vijayanagara period gold ornaments found in Gadag, Karnataka.</li>
    </ul>

    <h4>Frequently Asked Questions</h4>
    <h4>1. Which Article of the Constitution allows removal of the Lok Sabha Speaker?</h4>
    <p>Article 94 of the Indian Constitution allows the removal through a resolution passed by a majority of members.</p>

    <h4>2. Why is the Strait of Hormuz important?</h4>
    <p>It is a critical oil transit route where nearly 20% of global petroleum supply passes through daily.</p>

    <h4>3. What does "Right to Die with Dignity" refer to?</h4>
    <p>It refers to the right to withdraw life-support for terminal patients, linked to Article 21 (Right to Life).</p>

    <h4>4. Who is the new Lieutenant Governor of Delhi?</h4>
    <p>Taranjit Singh Sandhu, a former Indian diplomat, is the news 23rd LG of Delhi.</p>
</div>
`
};
