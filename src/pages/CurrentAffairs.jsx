                    ...
                    <aside className="lg:col-span-4 space-y-8">
                        ...
                        <section className={`rounded-xl overflow-hidden border ${borderColor} ${cardBg} shadow-md`}>
                            ...
                            <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
                                {headlines.map((h, i) => (
                                    <Link key={i} to="/current-affairs" className={`block p-4 text-[13.5px] font-medium ${h.includes('Jal Mahotsav') ? 'text-rose-500' : 'text-zinc-700 dark:text-zinc-300'} hover:text-rose-500 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all leading-snug`}>
                                        {h}
                                    </Link>
                                ))}
                            </div>
