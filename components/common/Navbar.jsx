...
const mainCategories = [
    ...
    // },
    {
        ...
        subcategories: [
            { name: 'Notes', path: '/study-materials', Icon: FileText },
            { name: 'PDFs', path: '/study-materials', Icon: FileDown },
            { name: 'Cheat Sheets', path: '/study-materials', Icon: Scroll },
            { name: 'Important Formulas', path: '/study-materials', Icon: Sigma },
            { name: 'Exam Guides', path: '/study-materials', Icon: GraduationCap },
        ],
    },
    {
        ...
        subcategories: [
            { name: 'Career Guidance', path: '/blog?category=career', Icon: TrendingUp },
            { name: 'Exam Preparation Tips', path: '/blog?category=exam-prep', Icon: Lightbulb },
            { name: 'Programming Tutorials', path: '/blog?category=tutorials', Icon: MonitorPlay },
            { name: 'Productivity', path: '/blog?category=productivity', Icon: Zap },
            { name: 'Student Success Stories', path: '/blog', Icon: Medal },
        ],
    },
    {
        ...
        subcategories: [
            { name: 'IT Jobs', path: '/jobs', Icon: Laptop },
            { name: 'Government Jobs', path: '/jobs', Icon: Building2 },
            { name: 'Internships', path: '/jobs', Icon: GraduationCap },
            { name: 'Walk-In Drives', path: '/jobs', Icon: CalendarCheck },
            { name: 'Placement Updates', path: '/jobs', Icon: TrendingUp },
        ],
    },
    // {
